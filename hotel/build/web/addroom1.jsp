<%-- 
    Document   : room
    Created on : Jun 5, 2019, 12:47:14 PM
    Author     : user
--%>
...
<link rel="stylesheet" href="fonts/material-icon/css/material-design-iconic-font.min.css">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="reservation.jsp" class="nav-link">Booking</a></li>
        ...
        <div class="container">
          <div class="row slider-text align-items-end">
            <div class="col-md-10 col-sm-12 ftco-animate mb-4">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home</a></span> <span>Rooms</span></p>
  ...
  <center>
      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-12 ftco-animate makereservation p-5 bg-light">
                    ...
                    <form action="custserv" style="border:1px solid #ccc" method="POST">
    ...
    <td><label for="Tele"><b>Hotel Name</b></label></td>
    <td><input type="text" placeholder="Enter Contact Hotel Name" name="Hname" required size="80"></td></tr>
      </tr>
       <tr>
    <td><label for="Tele"><b>Location</b></label></td>
    <td><input type="text" placeholder="Enter Location" name="Location" required size="80"></td></tr>
      </tr>
       <tr>
    <td><label for="Tele"><b>Telephone</b></label></td>
    <td><input type="text" placeholder="Enter Contact Number" name="tp" required size="80"></td></tr>
      </tr>
       <tr>
    <td><label for="Tele"><b>Owners Name</b></label></td>
    <td><input type="text" placeholder="Enter Owner Name" name="oname" required size="80"></td></tr>
      </tr>
      <tr>
   <td> <label for="email"><b>Email</b></label></td>
    <td><input type="text" placeholder="Enter Email" name="email" required size="80"></td></tr>

     
      <tr>
	<td><label for="User Name"><b>Picture/image of the Hotel</b></label></td>
    <td><input type="file" placeholder=" Enter User Name" name="usname" required size="80"></td></tr>
	
	

    
      
     <td> <label for="email"><b>Select Travel Type</b></label></td>
    <td> <select name ="type">
  <option value="couple">Perfect for Couples</option>
  <option value="student">Perfect for Students</option>
  <option value="Adults">Perfect for Adults</option>
  <option value="Visitor">Perfect For Visitors</option>
</select></td></tr>
...
<td></td>  
   <td> <label>
      <div class="form-submit">
                            <input type="submit" value="Add the Post" class="submit" id="submit" name="submit" />
        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">No 150/2 Moragahahena Road,Hoarna</a></li>
                <li><a href="#" class="py-2 d-block">+717584767</a></li>
                <li><a href="#" class="py-2 d-block">MLHW Products.com</a></li>
                <li><a href="#" class="py-2 d-block">lahiruhiranwijesooriyansbm@email.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
