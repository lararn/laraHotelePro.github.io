<%-- 
    Document   : tables
    Created on : Jun 8, 2019, 2:58:53 PM
    Author     : user
--%>
                                    ...
                                    <tr>
                                      ...
                                      <td><%= rs.getString("Country")%></td>
                                       ...
                                       <td><%= rs.getString("Address")%></td>
                                        ...
                                        <td><a href="update.jsp?var=<%= rs.getString("ID")%>">UPDATE</a></td>
                                       <td><a href="Delete.jsp?var=<%= rs.getString("ID")%>">DELETE</a></td>
                                    </tr>
                                                                     <% }
conn.close();
}
            ...
            <footer class="footer text-center">
                All Rights Reserved by MLHW Production Designed and Developed by <a href="https://lahiruhiranwijesooriyansbm@gmail.com">MLHW</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
