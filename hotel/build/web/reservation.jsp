<%-- 
    ...
    Created on : Jun 5, 2019, 12:46:13 PM
    Author     : user
--%>
        ...
        <div class="container">
          <div class="row slider-text align-items-end">
            <div class="col-md-10 col-sm-12 ftco-animate mb-4">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home</a></span> <span>Booking</span></p>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="select-wrap one-third">
                      ...
                      <select class="countrypicker form-control" data-live-search="true" data-default="Country of Passport" data-flag="false" name="date"></select>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"name="address" placeholder="Phone">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
               ...
               <form action="guest_details" method="POST">
              <div class="row mb-5">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="dob"  id="birth_date" placeholder="Birth Date">
                  </div>
                </div>
              </div>
               </form>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 d-flex">
                  <div class="form-group mr-4">
                    ...
                    <input type="text" class="form-control" id="arrival_date" name="adate" placeholder="Date">
                  </div>
                  <div class="form-group">
                    <label for="">Arrival Time</label>
                    <input type="text" class="form-control" id="arrival_time"  name="atime" placeholder="Time">
                  </div>
                </div>
                <div class="col-md-6 d-flex">
                  <div class="form-group mr-4">
                    <label for="">Departure Date</label>
                    <input type="text" class="form-control" id="departure_date" name="ddate" placeholder="Date">
                  </div>
                  <div class="form-group">
                    <label for="">Departure Time</label>
                    <input type="text" class="form-control" id="arrival_time" name="dtime" placeholder="Time">
                  </div>
                </div>
              </div>
               </form>
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cno" placeholder="">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group mr-4">
                    ...
                    <input type="text" class="form-control" id="expiration_date" name="exdate" placeholder="">
                  </div>
                </div>
              </div>
            </form>
